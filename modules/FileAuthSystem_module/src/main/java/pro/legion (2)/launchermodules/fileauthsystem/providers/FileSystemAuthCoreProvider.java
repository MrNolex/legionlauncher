package pro.legion.launchermodules.fileauthsystem.providers;
...
import pro.legion.launcher.request.auth.password.AuthPlainPassword;
import pro.legion.launchermodules.fileauthsystem.FileAuthSystemConfig;
...
import pro.legion.launchserver.auth.core.interfaces.provider.AuthSupportExit;
import pro.legion.launchserver.auth.core.interfaces.provider.AuthSupportRegistration;
import pro.legion.launchserver.auth.core.interfaces.user.UserSupportTextures;
import pro.legion.launchserver.auth.password.DigestPasswordVerifier;
import pro.legion.launchserver.auth.password.PasswordVerifier;
import pro.legion.launchserver.auth.texture.RequestTextureProvider;
