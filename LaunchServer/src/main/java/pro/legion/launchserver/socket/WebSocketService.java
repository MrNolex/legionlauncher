...
import pro.legion.launchserver.socket.handlers.WebSocketFrameHandler;
...
import pro.legion.launchserver.socket.response.auth.*;
import pro.legion.launchserver.socket.response.management.FeaturesResponse;
import pro.legion.launchserver.socket.response.management.GetPublicKeyResponse;
import pro.legion.launchserver.socket.response.management.ServerStatusResponse;
import pro.legion.launchserver.socket.response.profile.BatchProfileByUsername;
import pro.legion.launchserver.socket.response.profile.ProfileByUUIDResponse;
import pro.legion.launchserver.socket.response.profile.ProfileByUsername;
import pro.legion.launchserver.socket.response.secure.GetSecureLevelInfoResponse;
...
import pro.legion.launchserver.socket.response.secure.VerifySecureLevelKeyResponse;
import pro.legion.launchserver.socket.response.update.LauncherResponse;
import pro.legion.launchserver.socket.response.update.UpdateListResponse;
import pro.legion.launchserver.socket.response.update.UpdateResponse;
