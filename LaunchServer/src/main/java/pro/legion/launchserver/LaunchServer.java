...
import pro.legion.launcher.managers.ConfigManager;
...
import pro.legion.launchserver.auth.core.RejectAuthCoreProvider;
import pro.legion.launchserver.binary.EXEL4JLauncherBinary;
import pro.legion.launchserver.binary.EXELauncherBinary;
import pro.legion.launchserver.binary.JARLauncherBinary;
import pro.legion.launchserver.binary.LauncherBinary;
import pro.legion.launchserver.config.LaunchServerConfig;
import pro.legion.launchserver.config.LaunchServerRuntimeConfig;
import pro.legion.launchserver.launchermodules.LauncherModuleLoader;
import pro.legion.launchserver.manangers.*;
import pro.legion.launchserver.manangers.hook.AuthHookManager;
import pro.legion.launchserver.modules.events.*;
import pro.legion.launchserver.modules.impl.LaunchServerModulesManager;
import pro.legion.launchserver.socket.handlers.NettyServerSocketHandler;
import pro.legion.launchserver.socket.response.auth.RestoreResponse;
...
public final class LaunchServer implements Runnable, AutoCloseable, Reconfigurable {
    ...
    public LaunchServer(LaunchServerDirectories directories, LaunchServerEnv env, LaunchServerConfig config, LaunchServerRuntimeConfig runtimeConfig, LaunchServerConfigManager launchServerConfigManager, LaunchServerModulesManager modulesManager, KeyAgreementManager keyAgreementManager, CommandHandler commandHandler, CertificateManager certificateManager) throws IOException {
        ...
        pro.legion.launchserver.command.handler.CommandHandler.registerCommands(commandHandler, this);
