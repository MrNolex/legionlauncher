...
import pro.legion.launchserver.Reconfigurable;
import pro.legion.launchserver.auth.AuthException;
import pro.legion.launchserver.auth.core.interfaces.UserHardware;
import pro.legion.launchserver.auth.core.interfaces.provider.AuthSupportGetAllUsers;
import pro.legion.launchserver.auth.core.interfaces.provider.AuthSupportHardware;
import pro.legion.launchserver.auth.core.interfaces.provider.AuthSupportRegistration;
import pro.legion.launchserver.auth.core.interfaces.user.UserSupportHardware;
