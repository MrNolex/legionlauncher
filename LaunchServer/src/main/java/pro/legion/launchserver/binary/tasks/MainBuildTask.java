package pro.legion.launchserver.binary.tasks;
...
import pro.legion.launchserver.asm.ClassMetadataReader;
import pro.legion.launchserver.asm.InjectClassAcceptor;
import pro.legion.launchserver.asm.SafeClassWriter;
import pro.legion.launchserver.binary.BuildContext;
