...
import pro.legion.launcher.request.update.ProfilesRequest;
import pro.legion.launcher.request.websockets.StdWebSocketService;
import pro.legion.launcher.server.authlib.InstallAuthlib;
import pro.legion.launcher.server.launch.ClasspathLaunch;
import pro.legion.launcher.server.launch.Launch;
import pro.legion.launcher.server.launch.ModuleLaunch;
import pro.legion.launcher.server.launch.SimpleLaunch;
import pro.legion.launcher.server.setup.ServerWrapperSetup;
import pro.legion.utils.PublicURLClassLoader;
